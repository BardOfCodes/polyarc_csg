...
def test_single_primitive():
    """Test if a single primitive gls.PolyLine2D is correctly converted to a PolySet."""
    expr = gls.PolyLine2D([
...
def test_simple_boolean_operations():
    ...
    square_1 = gls.PolyLine2D([(0, 0, 0.0), (10, 0, 0.0), (10, 10, 0.0), (0, 10, 0.0)])
    square_2 = gls.PolyLine2D([(5, 5, 0.0), (15, 5, 0.0), (15, 15, 0.0), (5, 15, 0.0)])
...
def test_large_expression():
    ...
    outer_box = gls.PolyLine2D([(0, 0, 0.0), (50, 0, 0.0), (50, 50, 0.0), (0, 50, 0.0)])
    cutout_1 = gls.PolyLine2D([(10, 10, 0.0), (20, 10, 0.0), (20, 20, 0.0), (10, 20, 0.0)])
    cutout_2 = gls.PolyLine2D([(30, 30, 0.0), (40, 30, 0.0), (40, 40, 0.0), (30, 40, 0.0)])
...
def test_union_enclosed_polylines():
    ...
    union_expr = gls.Union(gls.PolyLine2D(outer_square.polyline), gls.PolyLine2D(inner_hole.polyline))
...
def test_union_intersecting_holes():
    ...
    exprs = [gls.PolyLine2D(tuple(square.polyline)) for square in squares]
